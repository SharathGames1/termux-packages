...
TERMUX_PKG_DEPENDS="python, freetype, giflib, glib, gtk3, gtkmm3, libc++, libcairo, libiconv, libjpeg-turbo, libpng, libtiff, libxml2, pango, readline, woff2, zlib"
TERMUX_PKG_CONFLICTS="fontforge"
TERMUX_PKG_REPLACES="fontforge"
TERMUX_PKG_EXTRA_CONFIGURE_ARGS="
-Python3_INCLUDE_DIRS=$(python3 -c "from distutils.sysconfig import get_python_inc; print(get_python_inc())")
